...
- If the improvement in fit is marginal and does not justify the extra parameter, t
he AIC/BIC increases (model with fewer knots is better)
...
Here, at year 1, the "Poor" group has 13.1 times and the "Medium" group 4.3 times 
the risk of the "Good" group. However, for every unit increase in log-time, those 
risk ratios drop by 50% and 35% (multiplied by 0.5 and 0.65), respectively. This 
suggests that the difference between the groups is greatest early on and diminishes 
as time passes.
