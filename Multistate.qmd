...
We will load in synthetic data that captures relapses and remission in opiod users, from entry into study. The published paper is [accessible here](https://journals.sagepub.com/doi/10.1177/0272989X251395679).

### Transition specific to each recurrence

We have provided two forms of the data. The below provides a transition for each recurrence:

![](https://raw.githubusercontent.com/NicoleDeLaMata/AdvancedSurvival/refs/heads/Webpage/recurrence_transition.png)
...
### Time-varying covariate for recurrence

The data for time-varying covariate for recurrence number is provided below.

![](https://raw.githubusercontent.com/NicoleDeLaMata/AdvancedSurvival/refs/heads/Webpage/recurrence_simple.png)
...
You have been provided with a [new dataset](https://github.com/NicoleDeLaMata/AdvancedSurvival/blob/Data/waitlist_trans.csv). The state space for this is below.

![](https://raw.githubusercontent.com/NicoleDeLaMata/AdvancedSurvival/refs/heads/Webpage/dataexercise_state.png)

Use the [coding template](https://github.com/NicoleDeLaMata/AdvancedSurvival/blob/Coding/multistate_exercise.R), which includes the variable list, to undertake similar datasteps and analysis above. Produce the:
...
Please refer to the solutions [here](https://nicoledelamata.github.io/AdvancedSurvival/multistate_exercise_solutions.html) and R coding [here](https://github.com/NicoleDeLaMata/AdvancedSurvival/blob/Quarto-docs/multistate_exercise_solutions.qmd) (uploaded following workshop).
