...
msm_alive_recur <- flexsurvspline(Surv(Tstart, Tstop, status) ~ trt +age10 + male + extent + node4, data=cdata_long, subset=(trans==1), k=0, scale="hazard")
msm_alive_recur

msm_alive_death <- flexsurvspline(Surv(Tstart, Tstop, status) ~ trt +age10 + male + extent + node4, data=cdata_long, subset=(trans==2), k=0, scale="hazard")
msm_alive_death

msm_recur_death <- flexsurvspline(Surv(Tstart, Tstop, status) ~ trt +age10 + male + extent + node4, data=cdata_long, subset=(trans==3), k=0, scale="hazard")
msm_recur_death
```
